	...
	<header id="header" class="fixed-top" >
					...
					<div class="col-lg-6 col-sm-6 col-8 header-top-right no-padding">
						...
						<ul style="border-right: none;" id="loginMem">
							<li>
								...
								| 	&nbsp;&nbsp; 
									<a href='#' >MyPage</a> 
								| 	<a style="padding-left:10px;" href="Plogout.me"> LogOut</a>
							</li>
						</ul>
		...
		<div class="container main-menu">
			<div class="row align-items-center justify-content-between d-flex" >
				<div id="logo">
					<a href="/PETNER/views/member/searchPwForm.jsp"><img style="width: 100px;" src="/PETNER/resources/img/common/petner_logo.jpg" alt="" title="" /></a>
				</div> <!-- sikim index  -->
				<nav id="nav-menu-container" >
					<ul class="nav-menu">
						<li><a href="/PETNER/index.jsp" ">Home</a></li>
						<li><a href="/PETNER/views/etc/about.jsp">ABOUT</a></li>
						<li><a href="/PETNER/hotelDbServlet">HOTEL</a></li>
